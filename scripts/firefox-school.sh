...
mkdir -p "$HOME/sandboxing-sandboxes/firefox-school"
mkdir -p "$HOME/sandboxing-sandboxes/firefox-school/Downloads"
...
( exec bwrap \
  ...
  --bind "$HOME/sandboxing-sandboxes/firefox-school" "/home/sandbox" \
  ...
  --ro-bind "$script_dir/firefox-school.runner" "/home/sandbox/firefox-school.runner" \
  /home/sandbox/firefox-school.runner "$@" \
 )

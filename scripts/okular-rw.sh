...
stdout_log_name="$HOME/sandboxing-sandbox-logs/okular-rw"/"$cur_time"."stdout"
...
( exec bwrap \
  ...
  --bind "$1" "/home/sandbox/$(basename "$1")" \
  --hostname "jail" \
  --unshare-user \
  --unshare-pid \
  --unshare-uts \
  ...
  --ro-bind "$script_dir/okular-rw.runner" "/home/sandbox/okular-rw.runner" \

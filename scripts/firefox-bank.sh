...
mkdir -p "$HOME/sandboxing-sandboxes/firefox-bank"
mkdir -p "$HOME/sandboxing-sandboxes/firefox-bank/Downloads"
...
( exec bwrap \
  ...
  --bind "$HOME/sandboxing-sandboxes/firefox-bank" "/home/sandbox" \
  ...
  --ro-bind "$script_dir/firefox-bank.runner" "/home/sandbox/firefox-bank.runner" \
  /home/sandbox/firefox-bank.runner "$@" \
 )
